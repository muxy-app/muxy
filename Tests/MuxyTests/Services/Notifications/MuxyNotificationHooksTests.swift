...
struct MuxyNotificationHooksTests {
    ...
    func openCodeReportsBridgeDeliveryFailures() throws {
        ...
        #expect(contents.contains("session_id: sessionID"))
        #expect(contents.contains("sessionEnded"))
        #expect(!contents.contains("sessionStarted"))
        #expect(!contents.contains("session-start"))
