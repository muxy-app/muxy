...
struct RemoteImagePasteServiceTests {
    ...
    func exactManagedPath() {
        ...
        #expect(!RemoteImagePasteService.isManagedPath(path, sessionID: "FEDCBA98-7654-3210-FEDC-BA9876543210", imageID: imageID))
        #expect(!RemoteImagePasteService.isManagedPath(path, sessionID: sessionID, imageID: "FEDCBA98-7654-3210-FEDC-BA9876543210"))
    }
}
