...
Copy the folder to `~/.config/muxy/extensions/muxy-starter-vue/` and rebuild to pick up changes. Theme colors use `var(--muxy-*)` and spacing follows a fixed scale; see the [extension docs](../../README.md).
