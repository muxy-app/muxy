...
See the [`muxy-extension` skill](https://github.com/muxy-app/muxy/blob/main/Muxy/Resources/skills/muxy-extension/SKILL.md#theme--follow-it-never-hardcode) for the full `--muxy-*` variable list and copy-paste CSS.
