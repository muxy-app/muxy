...
For AI coding agents (Antigravity CLI, Claude Code, Codex, Cursor, Droid, Grok, Kiro, Oh My Pi, OpenCode, Pi, Xal), Muxy uses hook-based lifecycle events rather than escape sequences — see [AI notifications](ai-notifications.md).
