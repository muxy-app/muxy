...
Set the default under **Projects -> Worktrees**. A template can use these filesystem-safe values:
...
Use **Choose Folder** to retain Muxy's existing folder layout. A global folder stores worktrees under
