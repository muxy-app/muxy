...
- **Sidebar Background** — uses a solid background or theme-tinted native macOS vibrancy across the sidebar and its traffic-light/title strip. The main topbar keeps the active theme background.
