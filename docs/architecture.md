...
Muxy/
  ...
  Models/
    ...
    StartupConfig.swift       Parser for .muxy/startup.{yaml,yml,json} declarative pane/tab layout (recursive panes/tabs schema)
    StartupWorkspaceBuilder.swift Builds a SplitNode/TabArea tree from StartupConfig
