...
public enum ExtensionBridgeJS {
    ...
    private static let gitBlock = """
            ...
            muxy.git = {
                ...
                repoInfo:      (o) => dispatch('git.repoInfo', { project: gitProject(o), fresh: Boolean((o || {}).fresh) }),
                ...
                branches:      (o) => dispatch('git.branches', { project: gitProject(o), fresh: Boolean((o || {}).fresh) }),
                remoteBranches:(o) => dispatch('git.remoteBranches', { project: gitProject(o), fresh: Boolean((o || {}).fresh) }),
                currentBranch: (o) => dispatch('git.currentBranch', { project: gitProject(o), fresh: Boolean((o || {}).fresh) }),
