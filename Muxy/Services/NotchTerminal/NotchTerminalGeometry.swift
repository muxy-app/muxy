...
enum NotchTerminalGeometry {
    static let defaultSize = NSSize(
        width: CGFloat(NotchTerminalSizePreferences.defaultWidth),
        height: CGFloat(NotchTerminalSizePreferences.defaultHeight)
    )
...
@MainActor
enum NotchTerminalScreenResolver {
