...
enum SettingsCatalog {
    ...
    static let items: [SettingsCatalogItem] = [
        ...
        SettingsCatalogItem(
            key: BrowserPreferences.homeURLKey,
            title: "Home Page",
            description: "URL opened when starting a new browser tab without an address.",
            category: .browser,
            section: "Home",
            defaultValue: "",
            aliases: ["url", "homepage", "start"]
        ),
        SettingsCatalogItem(
            key: BrowserPreferences.persistDataKey,
            title: "Persist Browsing Data",
            description: "Keeps browser cookies and site data between launches.",
            category: .browser,
            section: "Sessions",
            defaultValue: BrowserPreferences.defaultPersistData,
            aliases: ["cookies", "data", "storage"]
        ),
        SettingsCatalogItem(
            key: BrowserPreferences.autoOpenDevServerKey,
            title: "Auto-open Dev Servers",
            description: "Opens detected dev server URLs in a browser tab automatically.",
            category: .browser,
            section: "Dev Servers",
            defaultValue: BrowserPreferences.defaultAutoOpenDevServer,
            aliases: ["vite", "next", "npm", "pnpm", "yarn"]
        ),
        SettingsCatalogItem(
            key: BrowserPreferences.inspectableKey,
            title: "Enable Web Inspector",
            description: "Exposes Safari's Web Inspector inside browser tabs.",
            category: .browser,
            section: "Developer",
            defaultValue: BrowserPreferences.defaultInspectable,
            aliases: ["devtools", "developer", "inspect"]
        ),
    ]
