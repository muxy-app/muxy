...
pub(super) struct ViewState {
    ...
    pub(super) appearance_subscription: Option<Subscription>,
    pub(super) notification_quit_subscription: Option<Subscription>,
    pub(super) window_active: bool,
    pub(super) toast: crate::toast::ToastState,
    pub(super) notification_anchor: Option<Bounds<Pixels>>,
...
impl ViewState {
    pub(super) fn new(
        ...
        Self {
            ...
            notification_quit_subscription: None,
            window_active: false,
            toast: crate::toast::ToastState::default(),
